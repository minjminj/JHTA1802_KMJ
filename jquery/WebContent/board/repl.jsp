...
<body>
<h3 class='title animated slideInLeft'>Reply Of Board</h3>
...
<form name='frm_mem' id='frm_mem' method='post' enctype="multipart/form-data" >
	...
	<input type='text' name='serialParent' value='${param.serial}'/>
</form>
</div>
<script>check()</script>
</body>
