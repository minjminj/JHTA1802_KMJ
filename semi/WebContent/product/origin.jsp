...
<form name="find_str_now_page_form" method="post">
	...
	<input type='hidden' name='cate' value='origin' />
		...
		<section class="shop-page padding-top-100 padding-bottom-100">
			<div class="container">
				...
				<div class="papular-block row">
					...
					------------------------------------------->
					<c:forEach var='v' items='${prod_origin_list}'>
						<!-- Item -->
						<div class="col-md-3">
							<div class="item">
								<!-- Item img -->
									...
									<div class="overlay">
										<div class="position-center-center">
											<div class="inn" id='hm-padding-control'>
												<a href="${v.pho_vo.pho_rename1}" data-lighter><i class="icon-magnifier"></i></a>
													<!-- hover시 장바구니 버튼 -->
					...
					<ul class="pagination in-center">
						...
						<!-- 왼쪽화살표 버튼 -->
						<c:if test="${prod_origin_dao.now_block > 1}">
							<li><a href="#" onclick="move_page(1)"><i class="fa fa-angle-double-left" id="hm-angle"></i></a></li>
							<li><a href="#" onclick="move_page(${prod_origin_dao.start_page - 1})"><i class="fa fa-angle-left" id="hm-angle"></i></a></li>
						</c:if>
						<!-- 왼쪽화살표 버튼 끝 -->
						
						<!-- 상품 페이지  -->
						<c:forEach var="p" begin="${prod_origin_dao.start_page}"
							end="${prod_origin_dao.end_page}">
							<c:if test="${p == prod_origin_dao.now_page}">
						...
						<!-- 오른쪽화살표 버튼  -->
						<c:if test="${prod_origin_dao.now_block < prod_origin_dao.tot_block}">
							<li><a href="#" onclick="move_page(${prod_origin_dao.end_page + 1})"><i class="fa fa-angle-right"
									id="hm-angle"></i></a></li>
							<li><a href="#" onclick="move_page(${prod_origin_dao.tot_page})"><i class="fa fa-angle-double-right"
									id="hm-angle"></i></a></li>
						</c:if>
					<!-- 오른쪽화살표 버튼 끝 -->
					</ul>
