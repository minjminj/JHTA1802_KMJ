...
public class Prod_origin_dao {
	...
	//origin 카테고리에 있는 상품정보만 가져오기(Prod_Servlet.java 에서 사용)
	// 상품 코드 하나에 상품 사진 하나만 가져옵니다.
	public List origin_select(String find_str) {
		page_compute(find_str);	//
		List list = new ArrayList();
		
		//find_str로 origin카테고리 중 상품이름, 상품 상세내용을 검색합니다.
